...
export default function Hero9() {
  return (
    <section className="relative bg-zinc-50 dark:bg-transparent lg:py-12 lg:pt-16 xl:px-12">
      ...
      <div className="flex rounded-b-[4rem] bg-zinc-900 object-cover py-12 align-middle dark:bg-zinc-900 dark:bg-gradient-to-r dark:from-zinc-950 dark:to-zinc-800 max-lg:sticky max-lg:z-20 max-lg:px-2 lg:h-[29rem] lg:w-3/4 lg:rounded-bl-none lg:rounded-br-[15rem] lg:rounded-tl-[15rem] lg:rounded-tr-[15rem] lg:ps-24 lg:pt-16 xl:rounded-tl-[20rem] xl:ps-52">
