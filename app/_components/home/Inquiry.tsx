...
export default function Inquiry() {
  return (
    <div className="flex w-full items-center justify-center gap-4 bg-zinc-900 py-4 dark:bg-zinc-50 max-lg:hidden max-lg:flex-col max-lg:text-center lg:h-36 lg:gap-16">
