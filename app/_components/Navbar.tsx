    ...
    <ul className="flex max-lg:justify-around max-lg:px-4 lg:gap-12 lg:dark:text-zinc-200">
      {navLinks.map((nav, idx) => (
        ...
        >
          ...
          >
            <div
              className={`${path === nav.href ? "bg-zinc-100/85 shadow-inner shadow-zinc-200 dark:bg-zinc-800/75 dark:shadow-none" : ""} flex justify-start gap-3 rounded-full px-5 py-4 dark:text-zinc-300`}
            >
              {nav.icon}
      ...
      <li className="relative flex cursor-pointer justify-center py-3 font-semibold lg:hidden">
        <div
          className={`flex justify-start rounded-md bg-zinc-100/75 px-5 py-4 dark:bg-zinc-100 dark:text-zinc-900`}
        >
          <Drawer>
